...
namespace EaglesNest.Web.Data.Migrations
{
    ...
    [Migration("20260531192915_AddOrganizationStatusAndStateAssignments")]
    partial class AddOrganizationStatusAndStateAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EaglesNest.Core.Domain.OrganizationUnit", b =>
                {
                    ...
                    b.Property<DateOnly?>("CharterDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("EaglesNest.Core.Domain.StateChapterAssignment", b =>
                {
                    ...
                    b.Property<Guid>("LocalChapterOrganizationUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("StateOrganizationUnitId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("LocalChapterOrganizationUnitId");
            ...
            modelBuilder.Entity("EaglesNest.Core.Domain.StateChapterAssignment", b =>
                {
                    b.HasOne("EaglesNest.Core.Domain.OrganizationUnit", "LocalChapterOrganizationUnit")
                        .WithMany()
                        .HasForeignKey("LocalChapterOrganizationUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EaglesNest.Core.Domain.OrganizationUnit", "StateOrganizationUnit")
                        .WithMany()
                        .HasForeignKey("StateOrganizationUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("LocalChapterOrganizationUnit");

                    b.Navigation("StateOrganizationUnit");
                });
